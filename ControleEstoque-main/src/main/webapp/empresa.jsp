...
<html>
    <head>
        ...
        <title>Controle de Estoque - Empresa</title>
            ...
            <div class="layout">
                ...
                <div class="form-card">
                    ...
                    <form action="empresa" method="POST">
                        ...
                        <input type="text" name="nome" value="${empresaEditando.nome}" required>

                        <label>CNPJ:</label>
                        <input type="text" name="cnpj" value="${empresaEditando.cnpj}" required>

                        <label>Telefone:</label>
                        <input type="text" name="telefone" value="${empresaEditando.telefone}" required>
                        ...
                        <c:if test="${not empty empresaEditando}">
                            <a href="empresa?acao=listagem" class="cancelar-link">Cancelar Edi&#231;&#227;o</a>
                        </c:if>
                    </form>
                </div>
                        ...
                        <tbody>
                            <c:choose>
                                <c:when test="${empty listagem}">
                                    <tr>
                                        <td colspan="5" class="nao-encontrado">Nenhuma empresa encontrada.</td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
                                    <c:forEach var="empresa" items="${listagem}">
                                        <tr>
                                            ...
                                            <td><a href="empresa?acao=pre-edicao&id=${empresa.id}" style="color:#00bcd4;">Editar</a></td>
                                            <td>
                                                <a href="empresa?acao=exclusao&id=${empresa.id}"
                                                   style="color:#ff5252;"
                                                   onclick="return confirm('Deseja excluir a empresa ${empresa.nome}?')">Excluir</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:otherwise>
